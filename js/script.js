const ApiKey = "d73f36cbe0d44cdfb5bcccacda05d10a";
...
function showTeamInfo(id) {
    title.innerHTML = 'Detail Info Team'
            ...
            <div class="col s12 m12">
              <div class="card">
                <div class="card-image">
                  <img src="${team.crestUrl}" height="300px">
                </div>
                <div class="card-content">
                  <span class="card-title">${team.name}</span>
                  <p>Alamat : ${team.address} <br> Sponsor : ${team.venue}</p>
                </div>
                <div class="card-tabs">
                    <ul class="tabs tabs-fixed-width">
                        <li class="tab"><a class="active" href="#test4">Pemain</a></li>
                    </ul>
                </div>
                <div class="card-content grey lighten-4">
                    <div id="test4"><ul class="collection">${players}</ul></div>
                </div>
              </div>
            </div>
          </div>`
